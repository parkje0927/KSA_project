...
from parrot_h5 import train_dataset, test_dataset, val_dataset, train_dataset_size, test_dataset_size, val_dataset_size
...
# 2) Set the image transformations for pre-processing and data augmentation options.
# For the training generator:
ssd_data_augmentation = SSDDataAugmentation(img_height=img_height,
                                            img_width=img_width,
                                            background=mean_color)

# 3) For the validation generator:
...
model_checkpoint = ModelCheckpoint(filepath='parrot_ssd300_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.hdf5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename='parrot_ssd300.csv',
                       separator=',',
                       append=True)
